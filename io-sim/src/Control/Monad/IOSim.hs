...
data Trace a = Trace !VTime !ThreadId !(Maybe ThreadLabel) !TraceEvent (Trace a)
...
traceEvents :: Trace a -> [(VTime, ThreadId, Maybe ThreadLabel, TraceEvent)]
...
traceMany :: [(VTime, ThreadId, Maybe ThreadLabel, TraceEvent)]
          -> Trace a -> Trace a
